...
import HourlyQuantityChart from "./HourlyQuantityChart";
...
describe("HourlyQuantityChart", () => {
  ...
  it("renders chart with data", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Quantity Sold by Product (Last 3 Days)"),
      ).toBeInTheDocument();
    });
  });
});
