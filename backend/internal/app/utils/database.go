...
func SeedDatabase(db *gorm.DB) {
	...
	db.Create(&models.Product{Name: "🎟️ Regular", Price: decimal.NewFromInt(40), Pos: 1, ApiExport: true})
	reducedProduct := &models.Product{Name: "🎟️ Reduced", Price: decimal.NewFromInt(20), Pos: 2, ApiExport: true}
	db.Create(reducedProduct)
	freeProduct := &models.Product{Name: "🎟️ Free", Price: decimal.NewFromInt(0), Pos: 3, ApiExport: true}
	db.Create(freeProduct)
	prepaidProduct := &models.Product{Name: "🎟️ Prepaid", Price: decimal.NewFromInt(0), Pos: 4, WrapAfter: true, ApiExport: true}
	db.Create(prepaidProduct)
	db.Create(&models.Product{Name: "👕 Male S", Price: decimal.NewFromInt(20), Pos: 10, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Male M", Price: decimal.NewFromInt(20), Pos: 11, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Male L", Price: decimal.NewFromInt(20), Pos: 12, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Male XL", Price: decimal.NewFromInt(20), Pos: 13, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Male XXL", Price: decimal.NewFromInt(20), Pos: 15, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Male XXXL", Price: decimal.NewFromInt(20), Pos: 16, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Male 4XL", Price: decimal.NewFromInt(20), Pos: 17, WrapAfter: true, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Female S", Price: decimal.NewFromInt(20), Pos: 20, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Female M", Price: decimal.NewFromInt(20), Pos: 21, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Female L", Price: decimal.NewFromInt(20), Pos: 22, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Female XL", Price: decimal.NewFromInt(20), Pos: 23, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "👕 Female XXL", Price: decimal.NewFromInt(20), Pos: 24, WrapAfter: true, TotalStock: gofakeit.IntRange(5, 30)})
	db.Create(&models.Product{Name: "☕ Coffee Mug", Price: decimal.NewFromInt(1), Pos: 30})
